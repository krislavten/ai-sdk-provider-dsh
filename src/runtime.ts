...
function bundledRuntime(): { command: string; args: string[] } {
  ...
  const demoPackageJson = require.resolve("@deepseek-ai/dsh-sdk-jsonrpc-demo/package.json");
...
export class DshRuntime {
  ...
  async run(
    ...
    return { events: result.events as unknown[], finalResponse: result.finalResponse };
  }
